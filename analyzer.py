...
def analyze_call(transcript: str, manager_name: str = "Менеджер") -> tuple[dict, bool]:
    ...
    user_prompt = (
        ...
        '  "residential_complex": "название ЖК или проекта из разговора, если не упомянут — Не определён",\n'
        '  "stages": [\n'
        '    {\n'
        ...
        '  "report_flags": {\n'
        '    "passive_sale": true если менеджер ограничился отправкой в WhatsApp и не пригласил на встречу или показ — иначе false,\n'
